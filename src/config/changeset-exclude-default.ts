...
export class ChangesetExcludeDefault implements ChangesetExclude {
    ...
    public fileExcludes: Array<string> = [
        ...
        "permissionsets/dlrs__LookupRollupSummariesFull.permissionset",
        "permissionsets/dlrs__LookupRollupSummariesReadOnly.permissionset",
        ...
        "staticresources/dlrs__jszip.resource",
        "staticresources/dlrs__jszip.resource-meta.xml",
